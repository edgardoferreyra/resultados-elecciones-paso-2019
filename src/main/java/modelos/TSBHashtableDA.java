...
public class TSBHashtableDA<K,V> implements Map<K,V>, Cloneable, Serializable
{
    ...
    public V get(Object key)
    {
        ...
        if(key == null) throw new NullPointerException("get(): parámetro null"); //Linea repetida
    ...
    private class KeySet extends AbstractSet<K>
    {
        ...
        private class KeySetIterator implements Iterator<K>
        {
            ...
            public void remove()
            {
                ...
                if(actualkey == null) actualkey=anteriorkey;
    ...
    private class EntrySet extends AbstractSet<Map.Entry<K, V>>
    {
        ...
        private class EntrySetIterator implements Iterator<Map.Entry<K, V>>
        {
            ...
            public void remove()
            {
                ...
                if(entryactual == null) entryactual=entryanterior;
                Object[] t = TSBHashtableDA.this.table;
                t[indice] = new Entry<K,V>(null,null,TOMBSTONE);
                indice --;
    ...
    private class ValueCollection extends AbstractCollection<V>
    {
        ...
        private class ValueCollectionIterator implements Iterator<V>
        {
            ...
            public void remove()
            {
                ...
                if(valoractual == null) valoractual=valoranterior;
                Object[] t = TSBHashtableDA.this.table;
                t[indice] = new Entry<K,V>(null,null,TOMBSTONE);
                indice --;
